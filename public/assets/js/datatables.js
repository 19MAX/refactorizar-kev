$(document).ready(function () {
    ...
    // Inicializar la tabla de certificados
    let certificatesTable = initializeDataTable("#certificatesTable", {
        responsive: true,
        buttons: [
            {
                extend: "pageLength",
            ...
            {
                text: '<i class="fa fa-lg fas fa-eye"></i>',
                titleAttr: 'Columnas visibles',
                className: 'js-mytooltip bg-info text-white',attr: {
                    'data-mytooltip-custom-class': 'align-center',
                    'data-mytooltip-direction': 'top',
                    'data-mytooltip-theme': 'info',
                    'data-mytooltip-content': 'Columnas visibles'
    ...
    // Inicializar la tabla de historial de certificados
    let historialTable = initializeDataTable("#historialTable", {
        responsive: true,
        buttons: [
            {
                extend: "pageLength",
