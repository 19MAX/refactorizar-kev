...
$routes->group('admin', static function ($routes) {
    ...
    // Rutas originales de certificados (para archivos subidos)
    ...
    $routes->post('certificados/guardar-configuracion', 'Admin\CertificadosController::guardarConfiguracion');
